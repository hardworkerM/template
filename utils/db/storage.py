...
class DatabaseManager(object):
    ...
    def create_tables(self):
        self.query('CREATE TABLE IF NOT EXISTS user (id int, name text, phone text, mail text)')
        self.query("""CREATE TABLE IF NOT EXISTS memo (memo_id INTEGER PRIMARY KEY, 
                                                        user_id int, 
                                                        title text, 
                                                        description text,
                                                        date text, 
